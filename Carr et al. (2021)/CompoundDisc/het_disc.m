function [t, path] = het_disc(R_vec, P, v_0, delta, tau, n, do_vis)
    ...
    while(r < R_vec{end - 1}(theta))
        
        [new_x, new_y, p, new_theta, new_r] = get_new_pos(R_vec, P_vec, v(1), v(2), delta, n);
        prob = rand;
...
function [x2, y2, p, theta2, r2] = get_new_pos(R_vec, P_vec, x1, y1, delta, n)
